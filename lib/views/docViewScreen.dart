...
class DocViewScreen extends StatefulWidget {
  ...
  DocViewScreen({this.file, this.fileUrl, this.fileName});
  @override
...
class _DocViewScreenState extends State<DocViewScreen> {
  ...
  startDownload(TargetPlatform platform, String url)async{
    ...
    if(ready){
      ...
      taskId = await DownloadMethods.startDownload(widget.fileName, url, savedDir);
      // if(taskId != null)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: status != DownloadTaskStatus.running ? Text(
            widget.fileName,
