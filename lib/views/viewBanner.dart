            ...
            return Stack(
              ...
              children: [
                PageView.builder(
                    ...
                    banner == null || banner.isEmpty ? 1 : banner.length+1 :
                    banner.length,
                    itemBuilder: (context, index){
                      int banLength = banner == null || banner.isEmpty ? 0 : banner.length;
                      if(index < banLength){
                        return Stack(
                          ...
                          children: [
                            ...
                            widget.delTag != null ? Container(
                              ...
                              child: IconButton(
                                icon: Icon(Icons.cancel_rounded, color: Colors.white54),
                                iconSize: 45,
                                onPressed: (){
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 22.5, bottom: 13.5, right: 4.5),
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  widget.editAboutMe != null ? quote.isEmpty ?
                                  GestureDetector(
                                    onTap: (){
                                      showTextBoxDialog(
                                          context: context,
                                          text: "About Me",
                                          textEditingController: widget.quoteController,
                                          errorText: "Sorry, about me can not be empty",
                                          editQuote: widget.editAboutMe,
                                  ...
                                  widget.delTag != null && widget.editTag != null ? Container(
                                      height: 45,
