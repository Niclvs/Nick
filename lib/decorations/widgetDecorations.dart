...
hashTagFromDec(int tagLength, bool validHashTag){
  return InputDecoration(
      ...
      suffix: Wrap(
        ...
        children: [
          Text("$tagLength/18", style: TextStyle(fontSize: 14),),
          Icon(
            validHashTag ?
            Icons.check_circle :
    ...
    suffix: Wrap(
      ...
      children: [
        GestureDetector(
          ...
          child: Icon(
              valid ?
              maxLength != null ? Icons.check_circle : Icons.open_in_new_rounded :
              Icons.cancel_rounded,
              color: valid ? Colors.orange : Colors.red
          ),
        ),
        Text(maxLength != null ? "${textEtController.text.length}/$maxLength" : "\u221e")
      ],
    )
  );
}
...
msgInputDec({
  ...
  return InputDecoration(
    ...
    IconButton(
      icon: Icon(Icons.gif),
      onPressed: disabled == null || !disabled ? () async {
        ...
        if(gif != null){
          if(gif.images.original.webp != null){
            Map imgObj = {
              ...
              "imgName":gif.title,
              "gif":gif.isSticker == 0, "sticker":gif.isSticker == 1
            };
