...
Widget mediaFuncColumn(
  ...
  Map imgObj = mediaObj != null && mediaObj["imgName"] != null ? mediaObj : null;
  Map fileObj = mediaObj != null && mediaObj["fileName"] != null ? mediaObj : null;
  ...
  return StreamBuilder(
    ...
    builder: (context, snapshot) {
      ...
      if(snapshot.hasData && snapshot.data.data() != null){
        List notVisibleTo = snapshot.data.data()["notVisibleTo"] != null ? snapshot.data.data()["notVisibleTo"] : [];
        removed = notVisibleTo.contains(Constants.myUserId);
      }
      return !removed ? GestureDetector(
        onTap: (){
          if(mediaObj != null){
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => mediaObj["fileName"] == null || !pdfChecker(mediaObj["fileName"]) ?
                    MediaViewScreen(
                      mediaObj: mediaObj,
                      senderId: userId,
                      mediaId: mediaId,
              ...
              children: [
                ...
                SizedBox.expand(
                  child: mediaAndFilePreview(
                    senderId: userId,
                    context:context,
                    imgObj: mediaObj["imgName"] != null ? mediaObj : null,
                    fileObj: mediaObj["fileName"] != null ? mediaObj : null,
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: mediaGallery == null ? mediaViewDec() : null,
                    child: Column(
                ...
                Align(
                  ...
                  Container(
                    ...
                    child: CarouselSlider(
                        items: [
                          groupIcon(context, groupId, hashTag, admin, groupProfile, groupState, anon, oneDay, createdAt),
                          userIcon(context, userId, userName, userProfile, anonProfile, anon, blocked)
                        ],
        ...
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Text("Media has been removed", style: TextStyle(color:Colors.grey)),
          SizedBox(height: 10,),
          TextButton(
            onPressed: () {
              DatabaseMethods(uid: Constants.myUserId).undoRemoveMedia(mediaId);
            },
