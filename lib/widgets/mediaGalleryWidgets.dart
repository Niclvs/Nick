...
class _MediaGalleryTileState extends State<MediaGalleryTile> {
  ...
  void initState() {
    ...
    setState(() {
      current = widget.startIndex != null ? widget.startIndex : 0;
    });
    super.initState();
  }
      ...
      children: [
        CarouselSlider(
            ...
            return ClipRRect(
              ...
              SizedBox.expand(
                child: mediaAndFileDisplay(
                  ...
                  div:widget.profileIndex != null ? widget.profileIndex % 7 == 0 ? 3/2 : 3 : widget.div,
                  numOfLines: 1,
          ...
          options: CarouselOptions(
              ...
              widget.profileIndex % 7 == 0 ? devHeight/3 : devHeight/6 :
              widget.height,
