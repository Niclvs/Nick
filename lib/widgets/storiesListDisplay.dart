        ...
        return Column(
          ...
          children: [
                ...
                Stack(
                  ...
                  children: [
                    timerIndicator(
                        ...
                        color:seen != null && !seen ? Colors.orangeAccent : Colors.grey,
                        strokeWidth: 2
                    ),
                    Container(
                        width: height,
                              ...
                              children: [
                                SizedBox.expand(
                                  ...
                                  mediaAndFileDisplay(
                                    context: context,
                                    imgObj: mediaObj,
                                    div:MediaQuery.of(context).size.width/60,
                                    mediaId:storyId,
                                    senderId: senderId,
                                    showInfo:true,
                                    anon:anon,
                                ...
                                viewUser && !owner && sender == null && (anon != null && anon) ?
                                Container(
                                  color: Colors.white,
                ...
                Positioned(
                    ...
                    child: Container(
                        ...
                        child: Icon(
                          type == "regular" ?
                          Icons.send_rounded :
                          type == "friends" ? Icons.auto_awesome :
            ...
            sender != null ? Padding(
              ...
              child: Text(
                  anon != null && anon ? "Anonymous" : sender,
...
Widget storyList({
  ...
  return Container(
    ...
    width: width,
    alignment: align,
    child: !singleDisplay ? ListView.builder(
      ...
      children: [
        storyTile(
            ...
            owner: snapshot.data.docs[0].data()["senderId"] == Constants.myUserId,
        ...
        Icon(Icons.dynamic_feed_rounded, color: Colors.orange,) :
        SizedBox.shrink()
      ],
    ),
  );
