...
class CameraMethods{
  ...
  static onSwitchCamera(List cameras, int selectedCameraIndex, Function initCamera) {
  ...
  static onCaptureForMulti(context, CameraController cameraController,) async {
    try{
  ...
  static stopVideoForMulti(BuildContext context, CameraController cameraController, String filepath,) async {
    try{
  ...
  static onCaptureVideo(BuildContext context, CameraController cameraController) async{
    try {
