...
class UploadMethods{
  ...
  Future getImage() async {
    var pickedImage = await ImagePicker().getImage(source: ImageSource.gallery, imageQuality: 25);
  ...
  Future getVideo() async {
    PickedFile pickedVideo = await ImagePicker().getVideo(source: ImageSource.gallery);
    if(pickedVideo != null){
  ...
  Future pickAndUploadMedia(String type, bool video) async {
    ...
    final String dirPath = !video ? '${extDir.path}/Pictures' : '${extDir.path}/Videos';
